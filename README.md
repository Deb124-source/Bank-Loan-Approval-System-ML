...
F1-Score (99.62%) — chosen because it balances precision (avoiding bad loans) and recall (not missing good applicants). This ensures the bank’s decision system is both safe and inclusive.
